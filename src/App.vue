...
<template>
    <header class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-4 d-md-block d-none shadow bg-white px-5" style="min-height: 100dvh;">
                <div v-if="user?.isAuthenticated" class="sticky-top">
                    <div class="row pt-5">
                        ...
                        <div class="col-12 mt-4">
                            <span class="fst-italic text-secondary">{{ account?.class }}</span><br>
                ...
                <div v-else class="sticky-top">
                    <div class="row pt-5">
                        <div class="col-12">
                            ...
                            <p class="mt-4">Most features will be disabled without an account, to fully use this application please login.</p>
